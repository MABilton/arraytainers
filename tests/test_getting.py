...
dict_tests = [
    ...
    {
        "key": (1,),
        "expected": Arraytainer({"a": np.array([3, 4]), "b": np.array([7, 8])}),
    },
    {"key": (0, 1), "expected": Arraytainer({"a": np.array(2), "b": np.array(6)})},
    # Slice key:
    {
        "key": slice(0, 1),
        "expected": Arraytainer({"a": np.array([[1, 2]]), "b": np.array([[5, 6]])}),
    },
    {
        "key": (slice(0, 1), slice(0, 1)),
        "expected": Arraytainer({"a": np.array([[1]]), "b": np.array([[5]])}),
    },
    {
        "key": (None, slice(None, None)),
        "expected": Arraytainer(
    ...
    {
        "key": (slice(0, None), 1),
        "expected": Arraytainer({"a": np.array([2, 4]), "b": np.array([6, 8])}),
    },
    {
        "key": (1, slice(None, 1)),
        "expected": Arraytainer({"a": np.array([3]), "b": np.array([7])}),
    },
    # Array keys:
    {
    ...
    },
    {
        ...
        "expected": Arraytainer({"a": np.array([1, 4]), "b": np.array([5, 8])}),
    },
    # Arraytainer keys:
    {
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in dict_tests]
)
...
jax_dict_tests = [
    ...
    {
        "key": (1,),
        "expected": Jaxtainer({"a": jnp.array([3, 4]), "b": jnp.array([7, 8])}),
    },
    {"key": (0, 1), "expected": Jaxtainer({"a": jnp.array(2), "b": jnp.array(6)})},
    # Slice key:
    {
        "key": slice(0, 1),
        "expected": Jaxtainer({"a": jnp.array([[1, 2]]), "b": jnp.array([[5, 6]])}),
    },
    {
        "key": (slice(0, 1), slice(0, 1)),
        "expected": Jaxtainer({"a": jnp.array([[1]]), "b": jnp.array([[5]])}),
    },
    {
        "key": (None, slice(None, None)),
        "expected": Jaxtainer(
    ...
    {
        "key": (slice(0, None), 1),
        "expected": Jaxtainer({"a": jnp.array([2, 4]), "b": jnp.array([6, 8])}),
    },
    {
        "key": (1, slice(None, 1)),
        "expected": Jaxtainer({"a": jnp.array([3]), "b": jnp.array([7])}),
    },
    # Array keys:
    {
    ...
    },
    {
        ...
        "expected": Jaxtainer({"a": jnp.array([1, 4]), "b": jnp.array([5, 8])}),
    },
    # Jaxtainer keys:
    {
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in jax_dict_tests]
)
...
list_tests = [
    ...
    {
        "key": slice(0, 1),
        "expected": Arraytainer([np.array([[1, 2]]), np.array([[5, 6]])]),
    },
    {
        "key": (slice(0, 1), slice(0, 1)),
        "expected": Arraytainer([np.array([[1]]), np.array([[5]])]),
    },
    {
        "key": (None, slice(None, None)),
        "expected": Arraytainer(
    ...
    {
        "key": (slice(0, None), 1),
        "expected": Arraytainer([np.array([2, 4]), np.array([6, 8])]),
    },
    {
        "key": (1, slice(None, 1)),
        "expected": Arraytainer([np.array([3]), np.array([7])]),
    },
    # Array keys:
    {
        "key": np.array([True, False]),
    ...
    {
        "key": np.array([[True, False], [False, True]]),
        "expected": Arraytainer([np.array([1, 4]), np.array([5, 8])]),
    },
    # Arraytainer keys:
    {
    ...
    {
        "key": Arraytainer(
            [np.array([True, False]), np.array([[True, False], [False, True]])]
        ),
        "expected": Arraytainer([np.array([[1, 2]]), np.array([5, 8])]),
    },
    {
        "key": Arraytainer(
            [np.array([[True, False], [False, True]]), np.array([True, False])]
        ),
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in list_tests]
)
...
jax_list_tests = [
    ...
    {
        "key": slice(0, 1),
        "expected": Jaxtainer([jnp.array([[1, 2]]), jnp.array([[5, 6]])]),
    },
    {
        "key": (slice(0, 1), slice(0, 1)),
        "expected": Jaxtainer([jnp.array([[1]]), jnp.array([[5]])]),
    },
    {
        "key": (None, slice(None, None)),
        "expected": Jaxtainer(
    ...
    {
        "key": (slice(0, None), 1),
        "expected": Jaxtainer([jnp.array([2, 4]), jnp.array([6, 8])]),
    },
    {
        "key": (1, slice(None, 1)),
        "expected": Jaxtainer([jnp.array([3]), jnp.array([7])]),
    },
    # Array keys:
    {
        "key": jnp.array([True, False]),
    ...
    {
        "key": jnp.array([[True, False], [False, True]]),
        "expected": Jaxtainer([jnp.array([1, 4]), jnp.array([5, 8])]),
    },
    # Jaxtainer keys:
    {
    ...
    {
        "key": Jaxtainer(
            [jnp.array([True, False]), jnp.array([[True, False], [False, True]])]
        ),
        "expected": Jaxtainer([jnp.array([[1, 2]]), jnp.array([5, 8])]),
    },
    {
        "key": Jaxtainer(
            [jnp.array([[True, False], [False, True]]), jnp.array([True, False])]
        ),
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in jax_list_tests]
)
...
nested = {
    ...
    "b": {"a": [np.array([[9, 10], [11, 12]])], "b": np.array([[13, 14], [15, 16]])},
}
nested_tests = [
    # Regular keys:
    {
    ...
    },
    {
        "key": "b",
        "expected": Arraytainer(
            {"a": [np.array([[9, 10], [11, 12]])], "b": np.array([[13, 14], [15, 16]])}
        ),
    },
    # Tuple keys:
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([3, 4]), np.array([7, 8])],
                "b": {"a": [np.array([11, 12])], "b": np.array([15, 16])},
            }
        ),
    },
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array(2), np.array(6)],
                "b": {"a": [np.array(10)], "b": np.array(14)},
            }
        ),
    },
    # Slice key:
        ...
        "expected": Arraytainer(
            {
                ...
                "b": {"a": [np.array([[9, 10]])], "b": np.array([[13, 14]])},
            }
        ),
    },
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([[1]]), np.array([[5]])],
                "b": {"a": [np.array([[9]])], "b": np.array([[13]])},
            }
        ),
    },
    # Slice and tuple:
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([2, 4]), np.array([6, 8])],
                "b": {"a": [np.array([10, 12])], "b": np.array([14, 16])},
            }
        ),
    },
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([3]), np.array([7])],
                "b": {"a": [np.array([11])], "b": np.array([15])},
            }
        ),
    },
    # Array keys:
    ...
    },
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([1, 4]), np.array([5, 8])],
                "b": {"a": [np.array([9, 12])], "b": np.array([13, 16])},
            }
        ),
    },
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([1, 3]), np.array([5, 7])],
                "b": {"a": [np.array([9, 11])], "b": np.array([13, 15])},
            }
        ),
    },
    ...
    # Arraytainer keys - broadcasting:
    {
        ...
        "expected": Arraytainer(
            {
                "a": [np.array([1, 4]), np.array([5, 8])],
                "b": {"a": [np.array([10, 11])], "b": np.array([14, 15])},
            }
        ),
    },
    {
        "key": Arraytainer(
            {
                "a": np.array([[True, False], [False, True]]),
                "b": {"a": np.array([[False, True], [True, False]])},
            }
        ),
        "expected": Arraytainer(
            {
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in nested_tests]
)
...
jax_nested = {
    ...
    "b": {"a": [jnp.array([[9, 10], [11, 12]])], "b": jnp.array([[13, 14], [15, 16]])},
}
jax_nested_tests = [
    # Regular keys:
    {
    ...
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([[9, 10], [11, 12]])],
                "b": jnp.array([[13, 14], [15, 16]]),
            }
        ),
    },
    # Tuple keys:
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([3, 4]), jnp.array([7, 8])],
                "b": {"a": [jnp.array([11, 12])], "b": jnp.array([15, 16])},
            }
        ),
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array(2), jnp.array(6)],
                "b": {"a": [jnp.array(10)], "b": jnp.array(14)},
            }
        ),
    },
    # Slice key:
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([[1, 2]]), jnp.array([[5, 6]])],
                "b": {"a": [jnp.array([[9, 10]])], "b": jnp.array([[13, 14]])},
            }
        ),
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([[1]]), jnp.array([[5]])],
                "b": {"a": [jnp.array([[9]])], "b": jnp.array([[13]])},
            }
        ),
    },
    # Slice and tuple:
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([2, 4]), jnp.array([6, 8])],
                "b": {"a": [jnp.array([10, 12])], "b": jnp.array([14, 16])},
            }
        ),
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([3]), jnp.array([7])],
                "b": {"a": [jnp.array([11])], "b": jnp.array([15])},
            }
        ),
    },
    # Array keys:
    ...
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([1, 4]), jnp.array([5, 8])],
                "b": {"a": [jnp.array([9, 12])], "b": jnp.array([13, 16])},
            }
        ),
    },
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([1, 3]), jnp.array([5, 7])],
                "b": {"a": [jnp.array([9, 11])], "b": jnp.array([13, 15])},
            }
        ),
    },
    ...
    # Jaxtainer keys - broadcasting:
    {
        ...
        "expected": Jaxtainer(
            {
                "a": [jnp.array([1, 4]), jnp.array([5, 8])],
                "b": {"a": [jnp.array([10, 11])], "b": jnp.array([14, 15])},
            }
        ),
    },
    {
        "key": Jaxtainer(
            {
                "a": jnp.array([[True, False], [False, True]]),
                "b": {"a": jnp.array([[False, True], [True, False]])},
            }
        ),
        "expected": Jaxtainer(
            {
...
@pytest.mark.parametrize(
    "key, expected", [(test["key"], test["expected"]) for test in jax_nested_tests]
)
...
@pytest.mark.parametrize(
    "key_tuple, expected",
    [(test["key_tuple"], test["expected"]) for test in successive_key_tests],
)
def test_getting_with_nested_arraytainer_using_successive_regular_keys(
    key_tuple, expected
):
...
@pytest.mark.parametrize(
    "key_tuple, expected",
    [(test["key_tuple"], test["expected"]) for test in jax_successive_key_tests],
)
def test_getting_with_nested_jaxtainer_using_successive_regular_keys(
    key_tuple, expected
):
