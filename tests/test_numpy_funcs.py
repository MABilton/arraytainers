...
single_arg_input = {
    "a": {"b": [np.array([[1, 2], [3, 4]]), np.array([[1]])]},
    "c": [np.array([[2, 1], [6, 7]]), np.array([[0.5, 0], [0, 0.5]])],
}
single_arg_tests = [
    {
        "func": np.exp,
        "expected": {
            "a": {"b": [np.exp([[1, 2], [3, 4]]), np.exp([[1]])]},
            "c": [np.exp([[2, 1], [6, 7]]), np.exp([[0.5, 0], [0, 0.5]])],
        },
    },
    {
        "func": np.sin,
        "expected": {
            "a": {"b": [np.sin([[1, 2], [3, 4]]), np.sin([[1]])]},
            "c": [np.sin([[2, 1], [6, 7]]), np.sin([[0.5, 0], [0, 0.5]])],
        },
    },
    {
        "func": np.linalg.det,
        "expected": {
            "a": {
                "b": [
                    np.array(np.linalg.det([[1, 2], [3, 4]])),
                    np.array(np.linalg.det([[1]])),
                ]
            },
            "c": [
                np.array(np.linalg.det([[2, 1], [6, 7]])),
                np.array(np.linalg.det([[0.5, 0], [0, 0.5]])),
            ],
        },
    },
    {
        "func": np.linalg.inv,
        "expected": {
            "a": {"b": [np.linalg.inv([[1, 2], [3, 4]]), np.linalg.inv([[1]])]},
            "c": [np.linalg.inv([[2, 1], [6, 7]]), np.linalg.inv([[0.5, 0], [0, 0.5]])],
        },
    },
    {
        "func": np.shape,
        "expected": {
            "a": {"b": [np.array([2, 2]), np.array([1, 1])]},
            "c": [np.array([2, 2]), np.array([2, 2])],
        },
    },
    {
        "func": lambda x: np.mean(x, axis=1),
        "expected": {
            "a": {"b": [np.mean([[1, 2], [3, 4]], axis=1), np.mean([[1]], axis=1)]},
            "c": [
                np.mean([[2, 1], [6, 7]], axis=1),
                np.mean([[0.5, 0], [0, 0.5]], axis=1),
            ],
        },
    },
    {
        ...
        "expected": {
            "a": {"b": [np.swapaxes([[1, 2], [3, 4]], 1, 0), np.swapaxes([[1]], 1, 0)]},
            "c": [
                np.swapaxes([[2, 1], [6, 7]], 1, 0),
                np.swapaxes([[0.5, 0], [0, 0.5]], 1, 0),
            ],
        },
    },
]
...
@pytest.mark.parametrize(
    "func, expected", [(test["func"], test["expected"]) for test in single_arg_tests]
)
...
binary_arg_input = {
    "a": {"b": [np.array([[1, 2], [3, 4]]), np.array(1)]},
    "c": [np.ones((2, 2, 2)), 0.5 * np.ones((2, 2))],
}
scalar = 3.67
        ...
        "expected": {
            "a": {
                "b": [
                    ...
                    np.array(np.array(1) + scalar),
                ]
            },
            "c": [np.ones((2, 2, 2)) + scalar, 0.5 * np.ones((2, 2)) + scalar],
        },
    },
    {
        "func": lambda x, y: x - y,
        ...
        "expected": {
            "a": {
                "b": [
                    ...
                    np.array(scalar + np.array(1)),
                ]
            },
            "c": [scalar + np.ones((2, 2, 2)), scalar + 0.5 * np.ones((2, 2))],
        },
    },
    {
        "func": lambda x, y: y - x,
...
@pytest.mark.parametrize(
    "func, expected",
    [(test["func"], test["expected"]) for test in binary_op_scalar_tests],
)
...
binary_op_array_tests = [
    {
        ...
        "expected": {
            "a": {
                "b": [np.array([[1, 2], [3, 4]]) + array, np.array(np.array(1) + array)]
            },
            "c": [np.ones((2, 2, 2)) + array, 0.5 * np.ones((2, 2)) + array],
        },
    },
    {
        "func": lambda x, y: x - y,
    ...
    },
    {
        ...
        "expected": {
            "a": {
                "b": [
                    np.array([[1, 2], [3, 4]]) ** array,
                    np.array((np.array(1)) ** array),
                ]
            },
            "c": [np.ones((2, 2, 2)) ** array, (0.5 * np.ones((2, 2))) ** array],
        },
    },
    {
        ...
        "expected": {
            "a": {
                "b": [array + np.array([[1, 2], [3, 4]]), np.array(array + np.array(1))]
            },
            "c": [array + np.ones((2, 2, 2)), array + 0.5 * np.ones((2, 2))],
        },
    },
    {
        "func": lambda x, y: y - x,
...
@pytest.mark.parametrize(
    "func, expected",
    [(test["func"], test["expected"]) for test in binary_op_array_tests],
)
...
binary_op_arraytainer_tests = [
    {
        ...
        "expected": {
            "a": {
                "b": [np.array([[1, 2], [3, 4]]) + val_1, np.array(np.array(1) + val_1)]
            },
            "c": [np.ones((2, 2, 2)) + val_2, 0.5 * np.ones((2, 2)) + val_2],
        },
    },
    {
        "func": lambda x, y: x - y,
    ...
    },
    {
        ...
        "expected": {
            "a": {
                "b": [
                    np.array([[1, 2], [3, 4]]) ** val_1,
                    np.array((np.array(1)) ** val_1),
                ]
            },
            "c": [np.ones((2, 2, 2)) ** val_2, (0.5 * np.ones((2, 2))) ** val_2],
        },
    },
    {
        ...
        "expected": {
            "a": {
                "b": [val_1 + np.array([[1, 2], [3, 4]]), np.array(val_1 + np.array(1))]
            },
            "c": [val_2 + np.ones((2, 2, 2)), val_2 + 0.5 * np.ones((2, 2))],
        },
    },
    {
        "func": lambda x, y: y - x,
    ...
    },
    {
        ...
        "expected": {
            "a": {
                "b": [
                    val_1 / np.array([[1, 2], [3, 4]]),
                    np.array(val_1 / (np.array(1))),
                ]
            },
            "c": [val_2 / np.ones((2, 2, 2)), val_2 / (0.5 * np.ones((2, 2)))],
        },
...
@pytest.mark.parametrize(
    "func, expected",
    [(test["func"], test["expected"]) for test in binary_op_arraytainer_tests],
)
...
def test_jaxtainer_binary_operators_with_jaxtainer(func, expected):
    contents = helpers.deepcopy_contents(binary_arg_input, has_jax_arrays=True)
    other_contents = helpers.deepcopy_contents(
        arraytainer_contents, has_jax_arrays=True
    )
    expected = helpers.deepcopy_contents(expected, has_jax_arrays=True)
...
einsum_tests = [
    {
        ...
        "einstr": "ijk,klm->ijlm",
        "expected": {
            "a": [3 * np.ones((3, 3, 3, 3)), 2 * np.ones((2, 2, 2, 2))],
            "b": 3 * np.ones((3, 2, 2, 3)),
        },
    },
    {
...
@pytest.mark.parametrize(
    "arg1, arg2, einstr, expected",
    [
        (test["arg1"], test["arg2"], test["einstr"], test["expected"])
        for test in einsum_tests
    ],
)
...
@pytest.mark.parametrize(
    "arg1, arg2, axis, expected",
    [
        (test["arg1"], test["arg2"], test["axis"], test["expected"])
        for test in concatenate_tests
    ],
)
...
stack_tests = [
    {
        ...
        "axis": 1,
        "expected": {
            "a": [np.ones((3, 5, 3)), np.ones((2, 5, 2, 2))],
            "b": np.ones((1, 5)),
        },
    },
    {
        ...
        "axis": {"a": 2, "b": 0},
        "expected": {
            "a": [np.ones((3, 3, 4)), np.ones((2, 2, 4, 2))],
            "b": np.ones((4, 1)),
        },
    },
]
...
@pytest.mark.parametrize(
    "arg, num, axis, expected",
    [
        (test["arg"], test["num"], test["axis"], test["expected"])
...
split_tests = [
    {
        ...
        "axis": 1,
        "expected": {
            "a": [3 * [np.ones((2, 2))], 3 * [np.ones((2, 1, 2))]],
            "b": 3 * [np.ones((1, 3))],
        },
    },
    {
        "arg": {
            "a": [np.ones((2, 4)), np.ones((2, 6, 2))],
            "b": [np.ones((1, 9)), np.ones((3, 3, 3))],
        },
        "sections": {"a": 2, "b": 3},
        "axis": 1,
        "expected": {
            "a": [2 * [np.ones((2, 2))], 2 * [np.ones((2, 3, 2))]],
            "b": [3 * [np.ones((1, 3))], 3 * [np.ones((3, 1, 3))]],
        },
    },
    {
        "arg": {
            "a": [np.ones((2, 4)), np.ones((2, 6, 2))],
            "b": [np.ones((10, 1)), np.ones((4, 3, 3))],
        },
        "sections": 2,
        "axis": {"a": 1, "b": 0},
        "expected": {
            "a": [2 * [np.ones((2, 2))], 2 * [np.ones((2, 3, 2))]],
            "b": [2 * [np.ones((5, 1))], 2 * [np.ones((2, 3, 3))]],
        },
    },
    {
        "arg": {
            "a": [np.ones((2, 4)), np.ones((2, 6, 2))],
            "b": [np.ones((9, 1)), np.ones((3, 3, 3))],
        },
        "sections": {"a": 2, "b": 3},
        "axis": {"a": 1, "b": 0},
        "expected": {
            "a": [2 * [np.ones((2, 2))], 2 * [np.ones((2, 3, 2))]],
            "b": [3 * [np.ones((3, 1))], 3 * [np.ones((1, 3, 3))]],
        },
    },
]
...
@pytest.mark.parametrize(
    "arg, sections, axis, expected",
    [
        (test["arg"], test["sections"], test["axis"], test["expected"])
