...
from_array_tests = [
    ...
    # Nested contents:
    {
        ...
        "order": None,
        "expected": {
            "a": [{"c": np.array([[1, 2], [3, 4]])}, np.array([[5, 6], [7, 8]])],
            "b": [np.array([[9, 10]]), {"c": np.array([[11, 12], [13, 14]])}],
        },
    },
    {
        "array": np.arange(1, 15),
    ...
    },
    {
        ...
        "order": "F",
        "expected": {
            "a": [{"c": np.array([[1, 3], [2, 4]])}, np.array([[5, 7], [6, 8]])],
            "b": [np.array([[9, 10]]), {"c": np.array([[11, 13], [12, 14]])}],
        },
    },
    {
...
@pytest.mark.parametrize(
    "array, shapes, order, expected",
    [
        (test["array"], test["shapes"], test["order"], test["expected"])
