...
class ArrayMixin:
    ...
    'reshape_list_using_arraytainer': cartesian_prod( [(3,4),(1,4)], 
                                                        ...
                                                        ([(12,1),(1,13)],'reshape_error') ), 'arraytainer' ), #([(4,3),(2,2),(2,2)],'key_error'),
    'reshape_dict_using_arraytainer': cartesian_prod( {'a':(2,2),'b':(4,1)}, 
                                                      ( ({'a':(4,1),'b':(2,2)},None), 
                                                        ([(4,1),(2,2)],'key_error'),
                                                        ({'a':{'c':(4,1)},'b':(2,2)},'key_error'),
                                                        ({'a':[(4,1)],'b':(2,2)},'key_error'),
                                                        ({'a':(5,1),'b':(2,2)},'reshape_error') ), 'arraytainer' ), #({'a':(4,1),'b':(2,2),'c':(2,2)},'key_error'),
    ...
    'reshape_2_key_broadcasting': cartesian_prod( [{'a':[(2,4),(8,)],'b':(8,1)},{'c':{'d':(2,3),'e':(3,2)}}], 
                                                  ( ([(1,8),(6,1)],None), 
                                                    ...
                                                    ({'a':[(1,8),(2,4)],'b':(1,8)}, 'key_error') ), 'arraytainer') #([{'a':[(2,4)],'b':(1,8)}, {'c':(6,)}], 'key_error'),
    }
